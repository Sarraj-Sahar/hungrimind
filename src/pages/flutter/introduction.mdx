...
<div>
  <img src="/introduction/comment2.png" style="padding: 0 5em" />
  <img src="/introduction/comment1.png" style="padding: 0 5em" />
</div>
...
Sorry for that rant, but that's what Hungrimind was built for! I want this to be the best place for people to learn Flutter, and you can be sure that the content here is accurate, up to date. Each page has an "Edit this page" button that leads to GitHub to flag a problem, and there is a whole community including me ready to fix it up.
